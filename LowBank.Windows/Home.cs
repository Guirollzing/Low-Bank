...
namespace LowBank.Windows
{
    public partial class Home : Form
    {
        ...
        private void LoadData()
        {
            ...
            string[] lines = File.ReadAllLines(@"C:\Users\Guilherme\Documents\GitHub\Low-Bank\LowBank.Windows\dados.csv");
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            amountLabel.Text = "Valor em conta: R$" + cliente.Account.Amount;
            userLabel.Text = $"Bem vindo: {cliente.Name}\nEmail: {cliente.Email}\nCPF: {string.Format(@"{0:000\.###\.###-##}", cliente.CPF)}\nTelefone: {string.Format(@"{0:\+00(00\)#####-####}", cliente.Telefone)}";
